...
Dada una cantidad total de minutos, calcular cuántas horas completas hay y cuántos minutos sobran. Los resultados deben devolverse a través de parámetros por referencia.
\begin{lstlisting}[style=customc, basicstyle=\ttfamily]
