...
Escribir programas simples pero completos en lenguaje C a partir de problemas de sentencias secuenciales para familiarizarse con tipos fundamentales de datos, operadores aritméticos y funciones de entrada y salida estándar.
